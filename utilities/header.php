            ...
            <div class="container"> <!-- Conteneur Bootstrap -->
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav"> <!-- Liste des éléments du menu de navigation -->
                        <a class="nav-link text-light ff-tw neonText <?= isActive('/', $current_url); ?>" aria-current="page" href="<?= $index_page; ?>">Accueil</a>
                        <a class="nav-link text-light ff-tw neonText <?= isActive('/produits', $current_url); ?>" href="<?= $produit_page; ?>">Nos produits</a>
                        <a class="nav-link text-light ff-tw neonText <?= isActive('/contact', $current_url); ?>" href="<?= $contact_page; ?>">Contact</a>
