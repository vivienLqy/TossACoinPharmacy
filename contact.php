            ...
            <form name="contact-form" id="formulaire" class="text-center mt-5">
                ...
                <div class="row mt-4 mx-0">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="md-form">
                            <input type="text" name="Sujet" id="inputSujet"
                                class="form-control bg-body-secondary rounded-0 text-uppercase" placeholder="Sujet">
                        </div>
                ...
                <div class="row mt-4 mx-0">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="md-form">
                            <textarea name="message" rows="6" id="InputMessage"
